...
CPU min MHz:           1200.0000 # 最小频率BogoMIPS: 6000.00
...
```bash
NAME="Ubuntu" # 操作系统名称
VERSION="18.04.4 LTS (Bionic Beaver)" # 版本信息
ID=ubuntu # 系统ID
ID_LIKE=debian # 类似系统ID
PRETTY_NAME="Ubuntu 18.04.4 LTS" # 友好名称
VERSION_ID="18.04" # 版本ID
HOME_URL="https://www.ubuntu.com/" # 官方网站链接
SUPPORT URL="https://help.ubuntu.com/" # 技术支持链接
BUG_REPORT_URL="https://bugs.launchpad.net/ubuntu/" # 错误报告链接
PRIVACY_POLICY_URL="https://www.ubuntu.com/legal/terms-and-policies/privacy-policy" # 隐私政策链接
VERSION_CODENAME=bionic # 版本代号
UBUNTU_CODENAME=bionic # UBUNTU版本代号
```
